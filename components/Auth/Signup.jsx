...
const Signup = ({onSubmitHandler, onChangeHandler, name, email, pass, inValid, error, classList, classList2, classList3, isLoading}) => {
  ...
  <button type="submit" style={{
    ...
    alignItems: 'center'
  }} className="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> {isLoading ? 'Loading....!!' : 'Sign Up'}  </button>
